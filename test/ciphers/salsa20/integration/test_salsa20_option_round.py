...
class TestSalsa20OptionRound(unittest.TestCase):

    @default_encrypt_args('-r', '20')
    def test_integration_salsa20_encrypt_rounds_20(self, _):
        c = bitseq64(
            0x0,
    ...
    @default_decrypt_args('-r', '20')
    def test_integration_salsa20_decrypt_rounds_20(self):
        p = bitseq(0x0, bit=4096)
        self.assertEqual(salsa20(), fhex(p))

    @unittest.skip(reason="Missing test vectors")
    @default_encrypt_args('-r', '12')
    def test_integration_salsa20_encrypt_rounds_12(self, _):
        pass

    @unittest.skip(reason="Missing test vectors")
    @default_decrypt_args('-r', '12')
    def test_integration_salsa20_decrypt_rounds_12(self):
        pass

    @unittest.skip(reason="Missing test vectors")
    @default_encrypt_args('-r', '8')
    def test_integration_salsa20_encrypt_rounds_8(self, _):
        pass
