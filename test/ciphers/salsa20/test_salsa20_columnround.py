...
class TestSalsa20CipherColumnRound(unittest.TestCase):
    def test_salsa20_columnround(self):
        ...
        y1 = Word(
            (0x10090288, 0x00000080, 0x00010200, 0x20500000),
            (0x00000101, 0x00048044, 0x00000080, 0x00010000),
            (0x00020401, 0x00002000, 0x80040000, 0x00000000),
            (0x40a04001, 0x00000200, 0x00402000, 0x88000100),
        )
